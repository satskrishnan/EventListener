...
import com.digital.core.banking.model.ModelApiResponse;
import com.digital.core.banking.model.Pet;

/**
 * A delegate to be called by the {@link PetApiController}}. Implement this
...
public interface PetApiDelegate {
	 ...
	 */
	default ResponseEntity<ModelApiResponse> uploadFile(Long petId, String additionalMetadata,
